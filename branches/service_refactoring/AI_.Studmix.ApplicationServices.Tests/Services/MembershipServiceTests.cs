...
namespace AI_.Security.Tests.Services
{
    public class MembershipServiceTests
    {
        ...
        {
            get { return _unitOfWork.GetRepository<User>().Get(); }
        }
        ...
        public void CreateUser_Simple_UserCreated()
        {
            ...
            UserStorage.Single().UserPrinciple.ShouldHave().Properties(
                usr => usr.UserName,
                usr => usr.Password,
                usr => usr.Email,
                usr => usr.IsApproved,
        ...
        public void CreateUser_UserNameInDifferentCaseProvided_CreatedUsersUserNameInLowerCase()
        {
            ...
            // Assert
            var savedUsername = UserStorage.Single().UserPrinciple.UserName;
        ...
        public void CreateUser_EmailInDifferentCaseProvided_CreatedUsersEmailInLowerCase()
        {
            ...
            // Assert
            var savedEmail = UserStorage.Single().UserPrinciple.Email;
        ...
        public void ChangePasswordQuestionAndAnswer_ValidUserDataProvided_QuestionAndAnswerChanged()
        {
            ...
            // Act
            var changed = _service.ChangePasswordQuestionAndAnswer(user.UserPrinciple.UserName,
                                                                   user.UserPrinciple.Password,
                                                                   newPasswordQuestion,
                                                                   newPasswordAnswer);
            // Assert
            UserStorage.Single().UserPrinciple.PasswordQuestion.Should().Be(newPasswordQuestion);
            UserStorage.Single().UserPrinciple.PasswordAnswer.Should().Be(newPasswordAnswer);
        ...
        public void ChangePasswordQuestionAndAnswer_InvalidUserDataProvided_QuestionAndAnswerNotChanged()
        {
            ...
            // Assert
            UserStorage.Single().UserPrinciple.PasswordQuestion.Should().Be(user.UserPrinciple.PasswordQuestion);
            UserStorage.Single().UserPrinciple.PasswordAnswer.Should().Be(user.UserPrinciple.PasswordAnswer);
